...
def pressure_gain_from_water_height(height):
    ...
    Parameters: height of the water column in meters
...
def pressure_loss_from_pipe(pipe_diameter, pipe_length, friction_factor, fluid_velocity):
    ...
    Paramters: pipe diameter (in meters), pipe length (in meters), friction factor, fluid velocity (in meters per second)
